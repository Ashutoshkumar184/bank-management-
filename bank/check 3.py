...
def disp_tr_hist(accnt):
	...
	l_title=tk.Message(disp_wn,text="BANK MANAGEMENT SYSTEM",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="red",justify="center",anchor="center")
	l_title.config(font=("Arial","50","bold"))
	l_title.pack(side="top")
...
def Main_Menu():
	...
	l_title.pack(side="top")
	imgc1=tk.PhotoImage(file="new1.gif")
	imglo=tk.PhotoImage(file="login.gif")
	imgc=imgc1.subsample(2,1)
